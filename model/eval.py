...
parser = argparse.ArgumentParser(
    description="validate the model on a contrastive learning dataset",
...
validation = DataLoader(
    dataset, shuffle=True, batch_size=batch_size, collate_fn=collator
)
...
model, validation = accelerator.prepare(
    model, validation)
